...
#     self.table = None
#     self.row_count = Metrics.counter(self.__class__.__name__, 'Row counter')
...
#         bundles.append(iobase.SourceBundle(sample_row_keys[0].offset_bytes, self, b'', sample_row_keys[0].row_key))
#     for i in range(1, len(sample_row_keys)):
#       pos_start = sample_row_keys[i - 1].offset_bytes
#       pos_stop = sample_row_keys[i].offset_bytes
#       bundles.append(iobase.SourceBundle(pos_stop - pos_start, self,
